...
class MCTSNode:
    ...
    def select_child(self):
        ...
        for child in self.children:
            if child.visits == 0:
                return child
            ucb1 = (child.wins / child.visits) + 10 * math.sqrt(math.log(self.visits) / child.visits)
            if ucb1 > max_ucb1:
                max_ucb1 = ucb1
    ...
    def expand(self):
        ...
        for move in legal_moves:
            ...
            child_state.drop_piece_adversarial(move) 
    ...
    def simulate(self):
        ...
        while Board.is_full(self.state):
...
#TODO: implementar algo que dê as wins de um no, winrate etc
